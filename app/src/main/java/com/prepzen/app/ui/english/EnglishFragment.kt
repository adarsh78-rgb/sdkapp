package com.prepzen.app.ui.english
...
class EnglishFragment : Fragment(R.layout.fragment_topic_list) {
    ...
    private val viewModel: TopicListViewModel by viewModels {
        TopicListViewModel.Factory(
            category = TopicCategory.ENGLISH,
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.sectionTitle.text = getString(R.string.english)
